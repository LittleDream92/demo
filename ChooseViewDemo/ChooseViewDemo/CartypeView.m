...
- (void)setUpChooseView {
    ...
    UITableView *tableView = [[UITableView alloc] initWithFrame:CGRectMake((self.frame.size.width-200)/2, (self.frame.size.height-120)/2, 200, 120) style:UITableViewStylePlain];
